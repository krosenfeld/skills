...
* [`/find-skills`](skills/find-skills) - Discover and install agent skills when looking for new capabilities.
* [`/github`](skills/github) - Interact with GitHub using the `gh` CLI (issues, PRs, runs, APIs).
* [`/karpathy-guidelines`](skills/karpathy-guidelines) - Behavioral guidelines to reduce common LLM coding mistakes.
